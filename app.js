...
const unitsConfig = [
  { id: 1, name: 'Unidad 1', topic: 'El problema de los siniestros de tránsito', icon: '⚠️', file: 'TRANSITO-PRUEBA UNIDAD 1.txt' },
  { id: 2, name: 'Unidad 2', topic: 'Principios de la Conducción',               icon: '⚙️', file: 'TRANSITO-PRUEBA UNIDAD 2.txt' },
  { id: 3, name: 'Unidad 3', topic: 'Convivencia Vial',                           icon: '🤝', file: 'TRANSITO-PRUEBA UNIDAD 3.txt' },
  { id: 4, name: 'Unidad 4', topic: 'El Individuo en el Tránsito',                icon: '👤', file: 'TRANSITO-PRUEBA UNIDAD 4.txt' },
  { id: 5, name: 'Unidad 5', topic: 'Usuarios Vulnerables',                       icon: '🚸', file: 'TRANSITO-PRUEBA UNIDAD 5.txt' },
  { id: 6, name: 'Unidad 6', topic: 'Normas de Circulación',                      icon: '🛣️', file: 'TRANSITO-PRUEBA UNIDAD 6.txt' },
  { id: 7, name: 'Unidad 7', topic: 'Circunstancias Especiales',                  icon: '🌧️', file: 'TRANSITO-PRUEBA UNIDAD 7.txt' },
  { id: 8, name: 'Unidad 8', topic: 'Informaciones Importantes',                  icon: '📋', file: 'TRANSITO-PRUEBA UNIDAD 8.txt' },
  { id: 9, name: 'Unidad 9', topic: 'Señalización de Tránsito',                   icon: '🛑', file: 'TRANSITO-PRUEBA UNIDAD 9.txt' },
];
